...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item Count the distance to the nearest zero-valued pixel (called zero-distance hereafter). This can be done with the OpenCV \texttt{distanceTransform} function. %% reference this
