...
void output_test::test_save_text_results() {
  CPPUNIT_FAIL("not implemented yet");
}

void output_test::test_show_graphic_results() {
  CPPUNIT_FAIL("not implemented yet");
}

void output_test::test_save_graphic_results() {
  CPPUNIT_FAIL("not implemented yet");
}

void output_test::test_save_results_to_file(){
  CPPUNIT_FAIL("not implemented yet");
}
