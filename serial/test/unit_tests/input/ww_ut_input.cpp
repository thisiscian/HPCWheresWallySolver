...
void input_test::test_no_arguments() {
  ...
  help_message << "\t-n,--number-of-results=N\tSets the number of results to be output" << endl;
  ...
  CPPUNIT_ASSERT(record_output.get_cerr_output() == help_message.str());
}
...
void input_test::test_option_config() {
  ...
  CPPUNIT_ASSERT( "../../sample_files/test_config.cfg" == input->variables->get_config_filename() );
  

  input->variables->set_load_config_from_file(false);
  input->variables->set_config_filename("");
...
void input_test::test_option_number_of_results() {
  // should be able to handle '--number-of-results=...' style input
  int argc = 2;
  char *argv[argc];
    argv[0] = new char[255];
    strcpy(argv[0], "./test_program_name");
    argv[1] = new char[255];
    strcpy(argv[1], "--number-of-results=5");
  input->parse_input(argc, argv);
...
void input_test::test_option_solve_puzzle() {
  ...
  CPPUNIT_ASSERT( "../../sample_files/test_puzzle_image.png" == input->variables->get_puzzle_image_filename() );

  input->variables->set_load_puzzle_from_file(false);
  input->variables->set_puzzle_image_filename("");
...
void input_test::test_option_load_results() {
  ...
  input->parse_input(argc, argv);
  if( input->variables->get_load_results_filename() == "../../sample_files/test_load_results.dat") cerr << "OKAY" << endl;
  CPPUNIT_ASSERT( true == input->variables->get_load_results_from_file() );
  CPPUNIT_ASSERT( "../../sample_files/test_load_results.dat" == input->variables->get_load_results_filename() );
...
void input_test::test_option_print_output() {
  ...
  input->parse_input(argc, argv);
  CPPUNIT_ASSERT( false == input->variables->get_print_results() );
  ...
  delete argv[1];
    ...
    input->parse_input(argc, argv);
  CPPUNIT_ASSERT( true == input->variables->get_verbose_print() );
  CPPUNIT_ASSERT( true == input->variables->get_print_results() );
}


void input_test::test_option_display_output() {
  ...
  input->parse_input(argc, argv);
  CPPUNIT_ASSERT( false == input->variables->get_display_results() );
  ...
  delete argv[1];
    ...
    strcpy(argv[2], "VERBOSE");
    input->parse_input(argc, argv);
  CPPUNIT_ASSERT( true == input->variables->get_verbose_display() );
  CPPUNIT_ASSERT( true == input->variables->get_display_results() );
}
...
void input_test::test_option_save_text_output() {
  ...
  char *argv[argc];
    ...
    strcpy(argv[0], "./test_program_name");
    argv[1] = new char[255];
    strcpy(argv[1], "--save-text-output=../../sample_files/test_print_output.dat");
  input->parse_input(argc, argv);
  CPPUNIT_ASSERT( true == input->variables->get_save_print_to_file() );
  CPPUNIT_ASSERT( "../../sample_files/test_print_output.dat" == input->variables->get_print_output_filename() );
  ...
  delete argv[1];
    ...
    strcpy(argv[1], "-St");
    argv[2] = new char[255];
    strcpy(argv[2], "../../sample_files/test_print_output.dat");
  input->parse_input(argc, argv);
  CPPUNIT_ASSERT( true == input->variables->get_save_print_to_file() );
  CPPUNIT_ASSERT( "../../sample_files/test_print_output.dat" == input->variables->get_print_output_filename() );
}

void input_test::test_option_save_image_output() {
  ...
  input->parse_input(argc, argv);
  CPPUNIT_ASSERT( true == input->variables->get_save_display_to_file() );
  CPPUNIT_ASSERT( "../../sample_files/test_image_output.dat" == input->variables->get_display_output_filename() );
...
void input_test::test_load_config() {
  ...
  input->variables->set_config_filename("../../sample_files/test_config_bad.cfg");
  record_output.start_recording_cerr();
    int err_no = input->load_config();
  record_output.stop_recording_cerr();
  CPPUNIT_ASSERT( BAD_CONFIG_FILE == err_no );
  //CPPUNIT_ASSERT( record_output.get_cerr_output() == "Error: config file contained some errors\n" );
  

  // should be able to load a 'good' config file
  input->variables->set_config_filename("../../sample_files/test_config.cfg");
  ...
  CPPUNIT_ASSERT( true == input->variables->get_load_results_from_file() );
  CPPUNIT_ASSERT( "../../sample_files/test_save_display.png" == input->variables->get_display_output_filename() );
  CPPUNIT_ASSERT( "../../sample_files/test_save_print.dat" == input->variables->get_print_output_filename() );
  CPPUNIT_ASSERT( "../../sample_files/test_puzzle_image.png" == input->variables->get_puzzle_image_filename() );
  CPPUNIT_ASSERT( "../../sample_files/test_load_results.dat" == input->variables->get_load_results_filename() );
}
...
void input_test::test_load_results() {
  ...
  input->variables->set_load_results_filename("../../sample_files/test_load_results_bad.dat");
  record_output.start_recording_cerr();
    int err_no = input->load_results();
  record_output.stop_recording_cerr();
  CPPUNIT_ASSERT( BAD_RESULTS_FILE == err_no );
  CPPUNIT_ASSERT( record_output.get_cerr_output() == "Error: results file contained some errors\n" );

  // should be able to load a 'good' results file
  input->variables->set_load_results_filename("../../sample_files/test_load_results.dat");
  ...
  CPPUNIT_ASSERT( expected_results == input->variables->get_load_results() );
  record_output.silence();
}
