...
#define hpc_wally_io_variables
  ...
  class IO_Variables {
    private:
      ...
      std::string puzzle_image_filename, config_filename, load_results_filename;
    public:
      ...
      bool get_print_results(), get_display_results();
      ...
      std::string get_puzzle_image_filename(), get_config_filename(), get_load_results_filename();
